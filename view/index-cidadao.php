        ...
        <a class="navbar-brand" href="#"><img src="img/webgente-fundo-escuro-120x40.png" alt=""></a>
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <!--Barra de ferramentas: barra para cálculo do IPTU entre outras funções-->
              
              <li class="nav-item active">
                <button type="button" class="btn btn-dark" onclick="barraPesquisas()" data-toggle="modal" data-target="#exampleModal">Pesquisas</button>
              </li>

              <li class="nav-item active">
                <button type="button" class="btn btn-dark" onclick="barraEdicao()">Ferramentas</button>
              </li>
              
              <li class="nav-item active">
                <button type="button" class="btn btn-dark" onclick="cadastro()">Cadastro</button>
              </li>
              <!--
              <li class="nav-item active">
                <button type="button" class="btn btn-dark" onclick="">Botão 4</button>
              </li>
              <li class="nav-item active">
                <button type="button" class="btn btn-dark" onclick="">Botão 5</button>
              </li>-->
               <!--Inicio da implementação do botão de cadastro como modal-->
              <!--
              <li class="nav-item active">
                <button type="button" class="btn btn-dark btn btn-primary" name="cadastro" data-toggle="modal" data-target="" onclick="cadastro()">Cadastrar</button>
              </li>
              </li>-->
              <li class="nav-item active">
                <button type="button" class="btn btn-dark"><a href="ajuda.html" target="_blank" style="color: white;">Ajuda</a></button>
              </li>   
